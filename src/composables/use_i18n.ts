...
const messages: Record<Language, Record<string, string>> = {
    zh: {
        ...
        'standalone-export.description': '保留探索、工具、设置、笔记、xlsx 和展开功能，生成可直接打开的单文件 HTML。',
        ...
        'standalone-export.builtin-note': '内置记号随兼容内核一起打包；本地列表只允许选择当前已信任且加载成功的文件。',
        'standalone-export.reading': '正在读取兼容内核…',
        ...
        'standalone-export.readonly-note': '独立版本不能编辑、上传、启用、禁用、删除或再次导出文件；可下载内嵌源码副本。',
    ...
    en: {
        ...
        'standalone-export.description': 'Keep exploration, tools, settings, notes, xlsx, and expansion in one HTML file that opens directly.',
        ...
        'standalone-export.include-data': 'Include current analysis, expansion trees, notes, display settings, and generator state',
        'standalone-export.builtin-note': 'Built-in notations are bundled by the compat kernel; local files must be trusted and loaded successfully.',
        'standalone-export.reading': 'Reading the compat kernel…',
        ...
        'standalone-export.readonly-note': 'Standalone exports cannot edit, upload, enable, disable, delete, or export notation files again; embedded sources can be downloaded.',
        ...
        'user-defined.download-body': 'Choose whether to save first or download the current draft without committing it.',
